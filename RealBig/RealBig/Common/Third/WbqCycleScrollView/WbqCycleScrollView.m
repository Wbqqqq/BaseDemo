...
NSString * const DefaultID = @"DefaultID";
NSString * const CustomID = @"CustomID";
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[WbqDefaultCollectionViewCell class] forCellWithReuseIdentifier:DefaultID];
    [mainView registerClass:[WbqCustomCollectionViewCell class] forCellWithReuseIdentifier:CustomID];
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        ...
        case WbqCycleCHIPageControlJalapenoStyle:
        {
            ...
            pageControl.numberOfPages = self.imagePathsGroup.count;
            pageControl.tintColor = [UIColor whiteColor];
            pageControl.currentPageTintColor = UIColorFromHex(0xf6a623);
            pageControl.userInteractionEnabled = NO;
            pageControl.progress = indexOnPageControl;
            pageControl.radius = 4.0;
            pageControl.padding = 5.0;
//            pageControl.borderWidth = 1;
        ...
        case WbqCycleCHIPageControlPuyaStyle:
        {
            ...
            break;
        case WbqCycleCHIPageControlCustomStyle:
        {
            CHIPageControlAleppo *pageControl = [[CHIPageControlAleppo alloc] init];
            pageControl.numberOfPages = self.imagePathsGroup.count;
            pageControl.tintColor = UIColorFromHex(0xfdae66);
            pageControl.currentPageTintColor = UIColorFromHex(0xeb8944);
            pageControl.userInteractionEnabled = NO;
            pageControl.progress = indexOnPageControl;
            pageControl.radius = 4.0;
            pageControl.padding = 5.0;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(self.dataSource)
    {
        if ([self.dataSource respondsToSelector:@selector(cellView:viewForItemAtIndex:)]) {
            ...
            WbqCustomCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:CustomID forIndexPath:indexPath];
    ...
    WbqDefaultCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:DefaultID forIndexPath:indexPath];
